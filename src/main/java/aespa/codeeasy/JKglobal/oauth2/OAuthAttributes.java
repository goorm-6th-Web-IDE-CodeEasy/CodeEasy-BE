...
import aespa.codeeasy.JKglobal.oauth2.userInfo.GoogleOAuth2UserInfo;
import aespa.codeeasy.JKglobal.oauth2.userInfo.KakaoOAuth2UserInfo;
import aespa.codeeasy.JKglobal.oauth2.userInfo.OAuth2UserInfo;
...
public class OAuthAttributes {
     ...
     * attributes : OAuth 서비스의 유저 정보들 소셜별 of 메소드(ofGoogle, ofKaKao, ofGithub)들은 각각 소셜 로그인 API에서 제공하는 회원의 식별값(id),
