...
public class SecurityConfig {
        ...
        return http
                ...
                .authorizeRequests(auth -> auth
                        .requestMatchers(
                                ...
                                new AntPathRequestMatcher("/problem"),
                                new AntPathRequestMatcher("/problemlist")
                        ).permitAll()
                ...
                .addFilterAfter(customJsonUsernamePasswordAuthenticationFilter(),
                        LogoutFilter.class) // LogoutFilter 이후에 사용자 정의 필터 추가
                .addFilterBefore(jwtAuthenticationProcessingFilter(),
                        UsernamePasswordAuthenticationFilter.class) // UsernamePasswordAuthenticationFilter 이전에 JWT 처리 필터 추가
                .build();
    }
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedMethods(
                Arrays.asList("GET", "POST", "PUT", "DELETE", "OPTIONS", "PATCH")); // 허용할 HTTP 메소드 설정
