...
public class FileExecute {
    ...
    public static ProjectResult executeFile(String code, String language, String[] testCase, Long timeLimit)
    ...
    private static ProjectResult commonProcess(Long timeLimit, String... strings)
            throws IOException, InterruptedException {
    ...
    private static ProjectResult commonProcess1(Long timeLimit, String... strings)
            throws IOException, InterruptedException {
        ProcessBuilder pb = new ProcessBuilder(strings);
        Process p = pb.start();
        ProjectResult response = new ProjectResult();
